...
public:
    ...
    QString getHost(const QString& bareJid);
    QString getPort(const QString& bareJid);

    void addAccount(const QString& bareJid, const QString& passwd ,const QString& host , const QString& port);
